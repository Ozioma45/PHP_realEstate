...
<main class=" m-auto  py-4 d-flex justify-content-center align-items-center w-100">
    ...
    <div class="card shadow-sm border-0 w-75">
        ...
        <div class="card-body">
                ...
                <form action="actions/add-property.php" method="POST" enctype="multipart/form-data" class="row g-4">
