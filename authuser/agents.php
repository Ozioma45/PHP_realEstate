    ...
    <?php 
        ...
        $stmt = $db->prepare("SELECT * FROM users WHERE role = 'agent' LIMIT $limit OFFSET $offset");
        $stmt->execute();
        $users = $stmt->fetchAll();
    ?>
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 py-4">
                ...
                <p>Dashboard /  <span class="text-muted">Agents</span></p>
                ...
                <div class="card shadow-sm border-0 mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3 mb-4">   
                            <h5 class="fw-semibold mb-0">Agents List</h5>

                           <div class="d-flex align-items-center gap-3 flex-wrap">

                             <div class="position-relative">
                                <i class="bi bi-search position-absolute top-50 start-0 translate-middle-y ms-3 text-muted"></i>
                                <input type="text" id="searchInput" class="form-control ps-5" placeholder="Search Agents...">
                            </div>
