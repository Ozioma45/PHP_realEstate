...
<section class="highlights p-5 mt-5 rounded shadow text-white">
        <div class="container">
            <div class="row g-4">
                <div class="col-md-3 d-flex flex-column align-items-center">
                    <span class="text-primary fs-2 fw-bold">15+</span>
                    <span>Years of Experience</span>
                </div>
                <div class="col-md-3 d-flex flex-column align-items-center">
                    <span class="text-primary fs-2 fw-bold">500+</span>
                    <span>Properties Sold</span>
                </div>
                <div class="col-md-3 d-flex flex-column align-items-center">
                    <span class="text-primary fs-2 fw-bold">300+</span>
...
<section class="testimonials p-5 mt-5 rounded">

      <div class="text-center mb-5">
        <h2 class="fw-bold">People Say The Nicest Things</h2>
        <p class="header-para">Real stories of trust, satisfaction, and success</p>
      </div>
        <!-- Carousel wrapper -->
      <div id="carouselExampleControls" data-bs-carousel-init class="carousel slide text-center carousel-dark" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
            <img class="rounded-circle shadow-1-strong mb-4"
                src="assets/img/testimonials/test2.jpg" alt="avatar"
                style="width: 150px;" />
            ...
            <img class="rounded-circle shadow-1-strong mb-4"
                src="assets/img/testimonials/test3.jpg" alt="avatar"
                style="width: 150px;" />
            <div class="row d-flex justify-content-center">
                <div class="col-lg-8">
            ...
            <div class="carousel-item">
            <img class="rounded-circle shadow-1-strong mb-4"
                src="assets/img/testimonials/test1.jpg" alt="avatar" style="width: 150px;" />
            <div class="row d-flex justify-content-center">
                <div class="col-lg-8">
        ...
        <button data-bs-button-init class="carousel-control-prev" type="button" data-bs-target="#carouselExampleControls"
            data-bs-slide="prev">
            <span class="carousel-control-prev-icon text-body" aria-hidden="true"></span>
            <span class="visually-hidden">Previous</span>
        </button>
        <button data-bs-button-init class="carousel-control-next" type="button" data-bs-target="#carouselExampleControls"
            data-bs-slide="next">
...
<!-- Footer -->
  <footer
          ...
          style="background: linear-gradient(to top, #000000, #051d41);"
          >
    <!-- Grid container -->
