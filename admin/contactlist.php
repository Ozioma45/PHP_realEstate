    ...
    <?php include 'includes/sidebar.php'; ?>
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 py-4">
                ...
                <p>Dashboard /  <span class="text-muted">Contact List</span></p>
                ...
                <div class="card shadow-sm border-0 mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3 mb-4">   
                            <h5 class="fw-semibold mb-0">Contact List</h5>
                            ...
                            <table class="table align-middle mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-muted">Property Enquiry</td>
                                        <td class="text-muted">I just wanted to know how many property </td>
                                        <td>
